...
model = Sequential([
    ...
    BatchNormalization(),
    Dropout(0.2),
    LSTM(60, activation='tanh', return_sequences=True, recurrent_regularizer=l2(0.0005), bias_regularizer=l2(0.0005), recurrent_dropout=0.1),
    BatchNormalization(),
    Dropout(0.2),
    LSTM(70, activation='tanh', return_sequences=False, recurrent_regularizer=l2(0.0005), bias_regularizer=l2(0.0005), recurrent_dropout=0.1),
    BatchNormalization(),
    Dropout(0.2),
