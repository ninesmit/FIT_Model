...
# Building a model
model = Sequential([
    LSTM(50, activation='tanh', return_sequences=True, input_shape=(seq_length, len(features))),
    BatchNormalization(),
    Dropout(0.2),
    LSTM(50, activation='tanh', return_sequences=True, recurrent_regularizer=l2(0.0005), bias_regularizer=l2(0.0005), recurrent_dropout=0.1),
    BatchNormalization(),
    Dropout(0.2),
    LSTM(50, activation='tanh', return_sequences=False, recurrent_regularizer=l2(0.0005), bias_regularizer=l2(0.0005), recurrent_dropout=0.1),
    BatchNormalization(),
    Dropout(0.2),
    Dense(140, activation='relu', kernel_regularizer=l2(0.0005)),
    Dropout(0.2),
