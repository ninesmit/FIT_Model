...
# Building a model
model = Sequential([
    LSTM(35, activation='tanh', return_sequences=True, input_shape=(seq_length, len(features))),
    BatchNormalization(),
    Dropout(0.2),
    LSTM(35, activation='tanh', return_sequences=True, recurrent_regularizer=l2(0.0005), bias_regularizer=l2(0.0005)),
    BatchNormalization(),
    Dropout(0.2),
    LSTM(35, activation='tanh', return_sequences=False, recurrent_regularizer=l2(0.0005), bias_regularizer=l2(0.0005)),
    BatchNormalization(),
    Dropout(0.2),
