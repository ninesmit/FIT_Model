...
model = Sequential([
    ...
    BatchNormalization(),
    Dropout(0.2),
    LSTM(50, activation='tanh', return_sequences=True, recurrent_regularizer=l2(0.0005), bias_regularizer=l2(0.0005)),
    BatchNormalization(),
    Dropout(0.2),
    LSTM(50, activation='tanh', return_sequences=False, recurrent_regularizer=l2(0.0005), bias_regularizer=l2(0.0005)),
    BatchNormalization(),
    Dropout(0.2),
